...
#     # Come back here - Need to add infra
#     source_address_prefixes    = ["${var.pks_services_subnet}", "${var.pks_infra_subnet}"]
#     #brismith  We can't have it like this because we are pre-defining the network and using "infra" network
