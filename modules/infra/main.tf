...
#   name                = "${var.env_name}boshvms-nsg1"
#   location            = "${var.location}"
#   resource_group_name = "${var.pcf_resource_group_name}"
...
#   name                = "${var.dns_subdomain}${var.dns_subdomain != "" ? "." : ""}${var.dns_suffix}"
#   resource_group_name = "${var.pcf_resource_group_name}"
# }
